...
def dump_checkpoint_vars(checkpoint_file, output_dir="weights", remove_variables_regex=""):
    ...
    manifest = {}
    remove_vars_compiled_re = re.compile(remove_variables_regex, re.IGNORECASE)
    ...
    for name in var_to_shape_map:
        ...
        manifest[name] = {'filename': var_filename,
